...
export default function ProfileCard({
  ...
  const tiltEngine = useMemo<TiltEngine>(() => {
  ...
  const getOffsets = useCallback((event: PointerEvent, element: HTMLDivElement) => {
  ...
  const cardStyle = useMemo(
    () =>
      ({
        ...
        "--behind-glow-color": behindGlowColor ?? "rgba(214, 255, 79, 0.34)",
        "--behind-glow-size": behindGlowSize ?? "46%",
