  ...
  it: {
    ...
    contact: {
      ...
      form: {
        ...
        success: "Brief inviato correttamente. Ti rispondo il prima possibile.",
        error: "Non sono riuscito a inviare il brief. Riprova tra poco oppure scrivimi via email.",
  ...
  en: {
    ...
    contact: {
      ...
      form: {
        ...
        sending: "Sending...",
        success: "Brief sent successfully. I will get back to you as soon as possible.",
        error: "I could not send the brief right now. Please try again shortly or email me directly.",
